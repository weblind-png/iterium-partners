      ...
      <div className="min-h-screen bg-[#0A2942] flex items-center justify-center px-4">
        <div className="bg-white rounded-3xl p-8 max-w-md w-full text-center">
          ...
          <p className="text-slate-500 text-sm mb-6">
            Votre profil expert n'a pas encore été créé. Veuillez remplir le formulaire d'inscription.
          </p>
          <a
            href="/expert"
            className="bg-[#F8B400] text-[#0A2942] font-bold py-3 px-6 rounded-2xl hover:bg-yellow-400 transition"
          >
        ...
        <div className="max-w-5xl mx-auto px-6 flex gap-6">
          {["profil", "demandes", "documents"].map((tab) => (
            <button
              ...
              className={`py-4 text-sm font-semibold border-b-2 transition capitalize ${
                activeTab === tab
      ...
      <div className="max-w-5xl mx-auto px-6 py-10">
        ...
        {activeTab === "demandes" && (
          <div className="bg-white rounded-3xl shadow p-8">
            <h2 className="text-xl font-bold text-[#0A2942] mb-6">Demandes de contact reçues</h2>
