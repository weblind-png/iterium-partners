      ...
      <header className="bg-[#0A2942] text-white border-b border-white/10">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              href="/auth/login"
              className="bg-[#F8B400] text-[#0A2942] px-5 py-2 rounded-xl text-sm font-bold hover:bg-yellow-400 transition"
            >
              Se connecter
            </Link>
          </div>
      ...
      <section className="relative overflow-hidden bg-[#0A2942] text-white">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 py-24 text-center">
          ...
          <div className="mt-12 flex flex-wrap items-center justify-center gap-4">
            ...
            <Link
              href="/auth/login"
              className="inline-flex items-center gap-3 border border-white/30 text-white px-8 py-4 rounded-2xl font-bold text-lg hover:bg-white/10 transition"
            >
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white border rounded-3xl p-8 shadow-sm hover:shadow-xl transition">
              ...
              <p className="text-slate-600 leading-relaxed">
                Exprimez votre problématique métier, votre urgence ou vos besoins stratégiques.
              </p>
            </div>
            ...
            <div className="bg-white border rounded-3xl p-8 shadow-sm hover:shadow-xl transition">
              ...
              <p className="text-slate-600 leading-relaxed">
                Notre moteur IA sélectionne les profils les plus pertinents selon votre besoin.
              </p>
            </div>
            ...
            <div className="bg-white border rounded-3xl p-8 shadow-sm hover:shadow-xl transition">
              ...
              <p className="text-slate-600 leading-relaxed">
                Contractualisation, conformité RGPD, paiement sécurisé et accès aux coordonnées après validation.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="bg-slate-50 py-24">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-600 mt-4 text-lg">
              Des profils seniors immédiatement mobilisables sur des missions stratégiques et sensibles.
            </p>
          </div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-600 mt-4 text-lg">
              Deux formules adaptées aux besoins des PME, ETI et grands groupes.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="border rounded-3xl p-10 shadow-sm bg-white">
              <h3 className="text-2xl font-bold text-[#0A2942] mb-4">Offre Standard</h3>
              <p className="text-slate-600 leading-relaxed mb-8">
                Idéale pour les entreprises souhaitant accéder rapidement à des experts seniors pour des besoins ponctuels.
              </p>
              <div className="text-5xl font-bold text-[#F8B400] mb-8">
                490€ <span className="text-lg text-slate-500 font-medium"> / an</span>
              </div>
              <ul className="space-y-4 text-slate-700 mb-8">
                <li className="flex gap-3"><CheckCircle2 className="w-5 h-5 text-[#F8B400]" />Accès à la plateforme IA</li>
                <li className="flex gap-3"><CheckCircle2 className="w-5 h-5 text-[#F8B400]" />Matching intelligent des profils</li>
                <li className="flex gap-3"><CheckCircle2 className="w-5 h-5 text-[#F8B400]" />Mise en relation sécurisée</li>
              </ul>
              <Link
                href="/auth/login"
                className="block w-full text-center bg-[#0A2942] text-white font-bold py-3 rounded-2xl hover:bg-slate-800 transition"
              >
            ...
            <div className="border-2 border-[#F8B400] rounded-3xl p-10 shadow-xl bg-white relative overflow-hidden">
              ...
              <h3 className="text-2xl font-bold text-[#0A2942] mb-4">Offre Premium Groupe</h3>
              <p className="text-slate-600 leading-relaxed mb-8">
                Pensée pour les organisations multi-entités nécessitant un pilotage centralisé et des besoins récurrents.
              </p>
              <div className="text-5xl font-bold text-[#F8B400] mb-8">
                1290€ <span className="text-lg text-slate-500 font-medium"> / an</span>
              </div>
              <ul className="space-y-4 text-slate-700 mb-8">
                <li className="flex gap-3"><CheckCircle2 className="w-5 h-5 text-[#F8B400]" />Accès multi-utilisateurs</li>
                <li className="flex gap-3"><CheckCircle2 className="w-5 h-5 text-[#F8B400]" />Reporting & suivi centralisé</li>
                <li className="flex gap-3"><CheckCircle2 className="w-5 h-5 text-[#F8B400]" />Priorisation des mises en relation</li>
              </ul>
              <Link
                href="/auth/login"
