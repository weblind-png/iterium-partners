...
import { ArrowRight, Users, Zap, ShieldCheck, Briefcase } from "lucide-react";
    ...
    <main className="min-h-screen bg-gradient-to-b from-white to-slate-50 text-slate-800">
      ...
      >
        <div className="max-w-4xl mx-auto text-center px-6">
          ...
          <p className="text-slate-200 text-lg mb-10">
            ...
            disponibles pour des besoins urgents en IT, DAF, conformité,
            cybersécurité, RH et bien plus encore.
          </p>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            >
              <Briefcase className="w-5 h-5" /> Devenir client
            </Link>
            <Link
              href="/expert"
              className="bg-transparent border border-white text-white font-semibold px-6 py-3 rounded-xl hover:bg-white hover:text-[#0A2942] transition inline-flex items-center gap-2"
            >
              <Users className="w-5 h-5" /> Devenir expert
            </Link>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-6xl mx-auto px-6 py-16 grid md:grid-cols-3 gap-8 text-center">
        ...
        <div className="p-6 border rounded-2xl shadow-sm hover:shadow-md transition">
          ...
          <p className="text-slate-600 text-sm mt-2">
            ...
            disponibilité. Itrium Conseil agit uniquement en tant qu’intermédiaire
            de mise en relation.
          </p>
        </div>
      ...
      <footer className="border-t py-6 text-center text-slate-500 text-sm bg-white">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-2 px-4">
          <p>
            © {new Date().getFullYear()} Itrium Conseil — Plateforme digitale IA B2B
          </p>
